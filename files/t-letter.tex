...
\def\setupletterlayout     [#1]{\setupletterstyle[#1]}
\def\setupletterlayer      [#1]{\setupletterstyle[#1][\v!layer]}
\def\setupletterframe      [#1]{\setupletterstyle[#1][\v!frame]}
\def\setuplettersection    [#1]{\setupletterstyle[#1]}
\def\setupletterdescription[#1]{\setupletterstyle[#1]}
\def\setupletteroptions    [#1]{\setupletterstyle[#1]}

\def\letterstyleparameter        {\letterstylevalue            }
\def\letterlayoutparameter       {\letterstylevalue            }
\def\letterlayerparameter      #1{\letterstylevalue{#1\v!layer}}
\def\letterframeparameter      #1{\letterstylevalue{#1\v!frame}}
\def\lettersectionparameter      {\letterstylevalue            }
\def\letterdescriptionparameter  {\letterstylevalue            }
\def\letteroptionparameter       {\letterstylevalue\v!option   }
