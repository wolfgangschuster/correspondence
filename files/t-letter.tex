...
\startinterface all
  \setinterfaceconstant {graphic}         {graphic}
     ...
     {\doifelsenothing{#3}
        {\ExpandSecondAfter\doifinsetelse{##1}\letter!list!sections
           ...
           {\ExpandSecondAfter\doifinsetelse{##1}\letter!list!descriptions
              ...
              {\ExpandSecondAfter\doifinsetelse{##1}\letter!list!layers
                 {\dododododosetupletterstyle[##1][\v!layer,\v!frame,\v!option][#2]}
                 {\dosetupletteroption[##1][#2]}}}}
  ...
  {\def\dodododododosetupletterstyle##1%
     {\processaction
        ...
        [    \v!layer=>{\dododododosetupletterstyle[#1][\v!layer\v!a,\v!layer\v!b][#3]},
         \v!layer\v!a=>{\setuplayer[\v!letter:#1][#3]},
...
\long\def\doiflettervalue#1%
  {\ifcsname\????ld#1\endcsname
     \edef\!!stringa{\csname\????ld#1\endcsname}%
     \ifx\!!stringa\empty
...
\long\def\doifelselettervalue#1%
  {\ifcsname\????ld#1\endcsname
     \edef\!!stringa{\csname\????ld#1\endcsname}%
     \ifx\!!stringa\empty
...
\def\doifletterstylevalue#1#2%
  {\ifcsname\????ls#1#2\endcsname
     \edef\!!stringa{\csname\????ls#1#2\endcsname}%
     \ifx\!!stringa\empty
       \@EAEAEA\gobbleoneargument
     \else
       \@EAEAEA\firstofoneargument
...
\def\doifelseletterstylevalue#1#2%
  {\ifcsname\????ls#1#2\endcsname
     \edef\!!stringa{\csname\????ls#1#2\endcsname}%
     \ifx\!!stringa\empty
       \@EAEAEA\secondoftwoarguments
...
\def\dododefineletterlayer[#1]%
  {\setvalue{\????ls\v!option#1}{\v!yes}%
   \doifnotinset{#1}\letter!list!layers
     {\appendtocommalist{#1}\letter!list!layers}%
...
\def\dosetletterlayer[#1]%
  {\doifinsetelse{#1}{\v!topmark,\v!botmark,\v!cutmark,\v!endmark,\v!usermark}
     {\doifelseletterstylevalue{#1}\c!symbol
...
\def\dosetlettersection[#1]%
  {\begingroup
   ...
   \doifelseletterstylevalue\@@lettersection\c!before
...
\def\letter!list!backgrounds
  {\v!letter:\c!backgroundimage,\v!letter:\c!background,%
   \v!letter:\v!letternext,\v!letter:\v!lettermain,\v!letter:\v!head,%
   \v!letter:\v!foot,\v!letter:\v!backaddress,\v!letter:\v!address,%
   \v!letter:\v!reference,\v!letter:\v!location,\v!letter:\v!nexthead,%
   \v!letter:\v!nextfoot,\v!letter:\v!topmark,\v!letter:\v!botmark,
   \v!letter:\v!cutmark,\v!letter:\v!endmark,\v!letter:\v!usermark}
...
\startsetups[letter:initialize]
  ...
  \doifletterstylevalue\v!option\c!bodyfont  {\switchtobodyfont[\@@@@lsoptionbodyfont]}
