...
\def\setupletterlayer      [#1]{\setupletterstyle[#1]}
\def\setupletterframe      [#1]{\setupletterstyle[#1]}
\def\setuplettersection    [#1]{\setupletterstyle[#1][\v!layer]}
\def\setupletterdescription[#1]{\setupletterstyle[#1][\v!frame]}
\def\setupletteroption     [#1]{\setupletterstyle[#1]}
